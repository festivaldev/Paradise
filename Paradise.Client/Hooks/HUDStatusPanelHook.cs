...
namespace Paradise.Client {
	public class HUDStatusPanelHook : IParadiseHook {
		...
		private static HUDNotifications HUDNotificationsInstance;

		public Type TypeToHook => typeof(HUDStatusPanel);
		...
		public void Hook() {
			var harmony = new Harmony("tf.festival.Paradise.HUDStatusPanelHook");
			...
			harmony.Patch(orig_HUDStatusPanel_GetRemainingKillString, new HarmonyMethod(prefix_HUDStatusPanel_GetRemainingKillString), new HarmonyMethod(postfix_HUDStatusPanel_GetRemainingKillString));
			...
			harmony.Patch(orig_HUDNotifications_GetGameModeHint, null, new HarmonyMethod(postfix_HUDNotifications_GetGameModeHint));

			var orig_WaitingForPlayersState_OnUpdate = TypeToHook.Assembly.GetType("WaitingForPlayersState").GetMethod("OnUpdate", BindingFlags.Instance | BindingFlags.Public);
			...
			harmony.Patch(orig_WaitingForPlayersState_OnUpdate, new HarmonyMethod(prefix_WaitingForPlayersState_OnUpdate), new HarmonyMethod(postfix_WaitingForPlayersState_OnUpdate));
		}

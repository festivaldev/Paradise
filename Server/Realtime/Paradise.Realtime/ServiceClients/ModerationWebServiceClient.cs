...
namespace Paradise.Realtime {
	public class ModerationWebServiceClient : BaseWebServiceClient<IModerationWebServiceContract> {
		...
		public ModerationWebServiceClient(string masterUrl, int port, string serviceEndpoint, string webServicePrefix, string webServiceSuffix) : base(masterUrl, port, serviceEndpoint, $"{webServicePrefix}ModerationWebService{webServiceSuffix}") { }

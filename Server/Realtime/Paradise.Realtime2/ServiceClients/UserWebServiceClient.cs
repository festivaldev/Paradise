...
namespace Paradise.Realtime {
	public class UserWebServiceClient : BaseWebServiceClient<IUserWebServiceContract> {
		...
		public UserWebServiceClient(string masterHostname, int port, string serviceEndpoint, string webServicePrefix, string webServiceSuffix) : base(masterHostname, port, serviceEndpoint, $"{webServicePrefix}UserWebService{webServiceSuffix}") { }

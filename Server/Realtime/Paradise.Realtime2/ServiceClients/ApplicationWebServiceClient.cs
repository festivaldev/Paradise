...
namespace Paradise.Realtime {
	public class ApplicationWebServiceClient : BaseWebServiceClient<IApplicationWebServiceContract> {
		...
		public ApplicationWebServiceClient(string masterHostname, int port, string serviceEndpoint, string webServicePrefix, string webServiceSuffix) : base(masterHostname, port, serviceEndpoint, $"{webServicePrefix}ApplicationWebService{webServiceSuffix}") { }

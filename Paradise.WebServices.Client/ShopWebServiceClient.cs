...
namespace Paradise.WebServices.Client {
	public class ShopWebServiceClient : WebServiceClientBase<IShopWebServiceContract> {
		public ShopWebServiceClient(string endpointUrl) : base(endpointUrl, $"{Properties.Resources.WebServicePrefix}ShopWebService{Properties.Resources.WebServiceSuffix}") { }

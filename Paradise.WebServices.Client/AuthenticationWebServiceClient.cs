...
namespace Paradise.WebServices.Client {
	public class AuthenticationWebServiceClient : WebServiceClientBase<IAuthenticationWebServiceContract> {
		public AuthenticationWebServiceClient(string endpointUrl) : base(endpointUrl, $"{Properties.Resources.WebServicePrefix}AuthenticationWebService{Properties.Resources.WebServiceSuffix}") { }

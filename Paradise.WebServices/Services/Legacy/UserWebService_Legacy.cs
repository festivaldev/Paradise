...
namespace Paradise.WebServices.Services {
	public class UserWebService_Legacy : WebServiceBase, IUserWebServiceContract_Legacy {
		...
		public UserWebService_Legacy(BasicHttpBinding binding, ParadiseSettings settings, IServiceCallback serviceCallback) : base(binding, settings, serviceCallback) { }

	...
	public class Loop : ILoop {
		...
		private void DoActions() {
			while (!_workQueue.IsEmpty) {
				...
				try { action(); } catch (ThreadAbortException) { throw; } catch (Exception e) { _exceptionHandler(e); }
			}
		}
		...
		private void DoUpdate() {
             ...
             */
			try { _handler(); } catch (ThreadAbortException) { throw; } catch (Exception e) { _exceptionHandler(e); }
		}
	}
}

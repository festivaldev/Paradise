...
namespace Paradise.Realtime.Server.Game {
	public class DebugGameState : GameState {
		private static readonly ILog Log = LogManager.GetLogger(typeof(DebugGameState));

		public DebugGameState(BaseGameRoom room) : base(room) { }
